...
Also exports ``write_json_cache`` and ``cancel_pending_tasks`` — shared
utilities used by the entity fetch stages.
"""
...
# ---------------------------------------------------------------------------
# Shared async utilities for cache writes and task cancellation.
# ---------------------------------------------------------------------------
