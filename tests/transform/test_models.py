...
These use factory helpers with realistic payloads.
...
from tests.factories import (
    element_type_row as _element_type_row,
...
@pytest.mark.unit
def test_player_helper_properties_are_not_persisted():
    """PlayerModel.model_dump() must exclude computed helper properties."""
    from fpl_ingest.transform.models import PlayerModel
    ...
    "elements": [
        ...
        },
        {
            ...
            "stats": {
                ...
                "bonus": 3, "bps": 50, "total_points": 13,
                "influence": "72.0", "creativity": "12.3", "threat": "88.0",
                "ict_index": "17.2", "expected_goals": "1.62", "expected_assists": "0.10",
                "expected_goal_involvements": "1.72", "expected_goals_conceded": "0.90",
                "starts": 1, "in_dreamteam": False,
            },
        },
    ]
}
