...
class TestShapeValidation:
    ...
    def test_validate_bootstrap_shape_flags_each_structural_failure(self, raw_kwargs, expected_failure):
    ...
    def test_validate_bootstrap_shape_passes_a_well_formed_payload(self):
    ...
    def test_validate_bootstrap_shape_requires_the_documented_keys(self):
    ...
    def test_validate_bootstrap_shape_accepts_an_empty_elements_list(self):
    ...
    def test_validate_bootstrap_shape_samples_rather_than_scans(self):
    ...
    def test_validate_bootstrap_shape_ignores_extra_top_level_keys(self):
...
class TestFetchAndCapture:
    ...
    @pytest.mark.asyncio
    async def test_ingest_core_data_writes_raw_object_under_fpl_bootstrap_static(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_ingest_core_data_sidecar_carries_capture_metadata(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_bootstrap_and_fixtures_share_one_run_manifest(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_capture_hands_events_and_element_ids_to_the_unmigrated_stages(self, tmp_path):
    ...
    def test_core_handoff_is_empty_for_an_unusable_payload(self):
        assert core_handoff(_raw(body=b"<html>nope</html>")) == ([], [])
        assert core_handoff(_raw([1, 2, 3])) == ([], [])

    def test_core_handoff_survives_a_payload_that_failed_shape_validation(self):
