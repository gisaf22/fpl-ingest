...
class TestShapeValidation:
    ...
    def test_validate_event_status_shape_flags_each_structural_failure(self, raw_kwargs, expected_failure):
    ...
    def test_validate_event_status_shape_passes_a_well_formed_payload(self):
    ...
    def test_validate_event_status_shape_accepts_an_empty_status_list(self):
    ...
    @pytest.mark.asyncio
    async def test_shape_failure_still_writes_the_payload_and_yields_no_finality(self, tmp_path):
...
class TestFetchAndCapture:
    ...
    @pytest.mark.asyncio
    async def test_ingest_event_status_writes_raw_object_under_fpl_event_status(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_ingest_event_status_sidecar_carries_capture_metadata(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_output_is_the_parsed_finality_map(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_an_event_is_settled_only_when_every_listed_date_is_final(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_an_event_is_settled_when_every_listed_date_is_final(self, tmp_path):
        payload = {
            "status": [
                {"bonus_added": True, "date": "2026-08-15", "event": 1, "points": "r"},
