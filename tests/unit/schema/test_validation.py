"""Tests for schema/validation.py — smoke test section."""
...
from fpl_ingest.schema.validation import SmokeTestFailure, run_smoke_test
...
def test_run_smoke_test_passes_for_expected_shapes():
    ...
    with patch("fpl_ingest.schema.validation.AsyncFPLClient", return_value=client):
